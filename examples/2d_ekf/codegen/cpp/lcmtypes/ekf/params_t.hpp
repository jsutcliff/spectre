...
#ifndef __ekf_params_t_hpp__
#define __ekf_params_t_hpp__
...
class params_t
{
    ...
    public:
        ...
        {
            uint64_t hash = 0x066493de0f5c67daLL;
            return (hash<<1) + ((hash>>63)&1);
        }

        // Comparison operators.
        inline bool operator==(const params_t& other) const;
        inline bool operator!=(const params_t& other) const;
        ...
        static uint32_t translate_fields(const char* const _fields[], uint32_t _field_indices_out[], uint32_t _num_fields) {
            if (strcmp(_fields[0], fields()[0]) == 0) {
                ...
                uint32_t ret = lcm::translate_fields<decltype(params_t::m)>(_fields + 1, _field_indices_out + 1, _num_fields - 1);
        ...
        uint32_t show_field(std::ostream& _stream, const uint32_t _field_indices[], uint32_t _num_fields, uint32_t _indent) const
        {
            ...
            switch (_field_indices[0]) {
                case 0:
                ret = lcm::show_field(_stream, _field_indices + 1, _num_fields - 1, m, _indent);
                return ret == 0 ? ret : ret + 1;
                default:
                return 1;
            }
        ...
        friend std::ostream& operator<<(std::ostream& _stream, const params_t& obj) {
        ...
        __attribute__((nodiscard)) uint32_t store_field(const uint32_t _field_indices[], uint32_t _num_fields, const char* const _value)
        {
            ...
            switch (_field_indices[0]) {
                case 0:
                ret = lcm::store_field(_field_indices + 1, _num_fields - 1, m, _value);
                return ret == 0 ? ret : ret + 1;
                default:
                return 1;
            }
...
__lcm_buffer_size params_t::encode(void *buf, __lcm_buffer_size offset, __lcm_buffer_size maxlen) const
{
...
__lcm_buffer_size params_t::decode(const void *buf, __lcm_buffer_size offset, __lcm_buffer_size maxlen)
{
...
__lcm_buffer_size params_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

constexpr uint64_t params_t::getHash()
{
    return _computeHash(NULL);
}

constexpr params_t::type_name_array_t* params_t::getTypeNameArrayPtr() {
    return &"params_t";
}

constexpr const char* params_t::getTypeName()
{
    return *params_t::getTypeNameArrayPtr();
}

constexpr params_t::package_name_array_t* params_t::getPackageNameArrayPtr() {
    return &"ekf";
}

constexpr const char * params_t::getPackageName()
{
    return *params_t::getPackageNameArrayPtr();
}

__lcm_buffer_size params_t::_encodeNoHash(void *buf, __lcm_buffer_size offset, __lcm_buffer_size maxlen) const
{
    __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size params_t::_decodeNoHash(const void *buf, __lcm_buffer_size offset, __lcm_buffer_size maxlen)
{
    __lcm_buffer_size pos = 0, tlen;
...
__lcm_buffer_size params_t::_getEncodedSizeNoHash() const
{
...
bool params_t::operator==(const params_t& other) const {
  return (
          (m==other.m));
}
